...
class Metall(models.Model):
    ...
    wiki_seo_title = models.CharField('Title', null=True, blank=True, max_length=300)
    wiki_seo_descript = RichTextField('Description', null=True, blank=True)
    wiki_seo_keywords = RichTextField('Keywords', null=True, blank=True)
